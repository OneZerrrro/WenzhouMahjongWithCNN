...
## [2026-06-15-03] Hisa
### Changed
- 现在可视化时会在副露和弃牌前显示“副露”和“弃牌”
### Repaired
- 修复了补杠会使该补杠手牌的数量变为负数导致判定出错的bug

## [2026-06-15-02] Hsia
### Repaired
- 修复了任意玩家补杠时会直接进入抢杠胡阶段并触发choose action的bug

## [2026-06-15-01] Hsia
### Repaired
- 修复了当指定初始手牌向听数的时候，手牌中某张牌的数量出现-1导致初始手牌17张的情况
- 修复了当财神牌为字牌，同时手牌中有多张该字牌（白板）的情况时强制打出字牌（白板）的情况
- 修复了当RuleBased玩家作为主视角玩家时，legal_action只包括0时无返回值的情况
